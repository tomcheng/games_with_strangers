defmodule YouBet.Questions do
  @one_off_questions [
    ...
    {:astronomy, "What is the temperature at the center of the Sun, in degrees Celcius?",
     15_000_000},
    {:biology, "How many muscles do cats have in each ear?", 32},
    {:biology, "On average, how many times a day does a cow defecate?", 16},
    {:biology, "How many breaths does the average adult take each year?", 8_409_600},
    ...
    {:biology, "How long are an average human's eyes closed per day due to blinking, in minutes?",
     30},
    ...
    {:biology, "What is the farthest distance a shark can sense a drop of blood, in meters?",
     4_000},
    ...
    {:geography,
     "As of 2016, how many cities, municipalities, districts, towns, townships, villages and hamlets does Canada have?",
     5_162},
    ...
    {:mathematics,
     "How many digits does the largest prime number known have (as of December 2017)?",
     22_338_618},
    ...
    {:records, "How many teddy bears are there in the world's largest teddy bear collection?",
     8_026},
    ...
    {:society,
     "How many trees worth of paper will the average American consume over their lifetime?", 465},
    {:society, "What was the average lifespan in the United States in 1900?", 47},
    {:sports, "How many hours did it take the first person to swim across the English Channel?",
     21},
  ...
  defp country_population do
    ...
    {"What was the population of " <> country <> " in " <> Integer.to_string(year) <> "?",
     population}
  end
  ...
  defp top_speed_of_car do
    ...
    {"In " <>
       ...
       ", the " <>
       car <> " was the fastest production car. What was it's top speed in kilometres per hour?",
     speed}
  end
  ...
  defp quality_of_living do
    ...
    {"According to the 2017 Mercer Quality of Living Ranking, out of 231 cities, with 1 being the best and 231 being the worst, where did " <>
       city <> ", " <> country <> " rank?", rank}
  end
  ...
  defp highest_sports_salary do
    ...
    {player <>
       " had the highest salary in " <>
       league <> " in the " <> season <> ". How much did he earn that season?", answer}
  end
end
